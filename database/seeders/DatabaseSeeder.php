...
Dalam tutorial ini, Anda akan diberikan contoh konkret dan panduan visual untuk memperkuat pemahaman Anda tentang penggunaan pengkondisian else if di JavaScript. Anda akan belajar cara mengevaluasi berbagai kondisi dan menentukan tindakan yang harus diambil berdasarkan hasil evaluasi tersebut.",
        ...
        Video::create([
            "category_id" => 4,
            "uploader_id" => 1,
            "title" => "Complete Portfolio Website with Bootstrap - HTML/CSS",
            "link" => "https://youtu.be/dgKSqz3it50?si=aEcmvjTWblRL13ny",
            "description" => "Complete Portfolio Website with Bootstrap - HTML/CSS In this video, we are going to learn and build how to create a complete portfolio website with bootstrap using HTML and CSS. We will understand everything from scratch.",
            "maker" => "Daily Tuition",
            "level" =>  "intermediate"
        ]);
        ...
        Video::create([
            "category_id" => 4,
            "uploader_id" => 1,
            "title" => "Notary - A Coding Project for HTML, CSS, and JavaScript",
            "link" => "https://youtu.be/KEvLAe_2jXo?si=3qLykwXIuRdwak6J",
            "description" => "Bobby Davis shows you how to use your current HTML, CSS, and JavaScript skills to create a job-winning project. Bobby takes you step-by-step through the creation of a website that can search through the text of Lord of the Rings and Alice in Wonderland. Learn how to display the most popular words and the least popular words in each book.",
            "maker" => "Coder Foundry",
            "level" =>  "intermediate"
        ]);
        ...
        Video::create([
            "category_id" => 4,
            "uploader_id" => 1,
            "title" => "Create a Weather App Using JavaScript, HTML and CSS | JavaScript Project",
            "link" => "https://youtu.be/KqZGuzrY9D4?si=OP-CTU99tF_rBuce",
